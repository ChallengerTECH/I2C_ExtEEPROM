/***
   ...
   byteWrite function: gonna overwrite the value @ the address, 
...
byte inNum = 121;//byte data to be stored in the External EEPROM. 
...
void setup() {
	...
	ExtEEPROM.byteWrite (10, inNum);//Write the data to the External EEPROM @ the mentioned address

	readNum = ExtEEPROM.byteRead (10);//Read the data from the External EEPROM @ the mentioned address 
